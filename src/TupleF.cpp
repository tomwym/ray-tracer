...
namespace Factory {
    ...
    auto Vector_t(const float& x, const float& y, const float& z) -> Tuple {
...
template auto Vector_t<float>(const float& x, const float& y, const float& z) -> TupleF;
